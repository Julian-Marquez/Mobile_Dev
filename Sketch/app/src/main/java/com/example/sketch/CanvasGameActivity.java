...
public class CanvasGameActivity extends AppCompatActivity {
    ...
    public void makenewCanvas() {
        ...
        for (User user : allUsers) {
            ...
            if(currentuser.getMyCanavas().isEmpty() || !tutorial){ // prompt the tutorial
                showOption.setTitle("The Drawing Game").setMessage("You will be given 3 minutes to draw a a random option." +
                        " When Time is up you wont be able to draw no more." +
                        " You have 3 Minutes to draw " + finalOption);
            }else {
                showOption.setTitle("Drawing Time").setMessage("You have 3 Minutes to draw " + finalOption);
            }
            ...
            showOption.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
            ...
            showOption.setCancelable(true).show();
